...
#
# 13 алхам:
#   1.  Систем шалгах (ОС, CPU, RAM)
#   2.  Системийн хамаарлууд (Python, WebKit2GTK, build tools)
#   3.  Програмыг хуулах → /opt/minii-delguur (DB нөөцтэй)
#   4.  Python виртуал орчин + хамаарлууд
#   5.  Өгөгдлийн сан үүсгэх / шинэчлэх
#   6.  Дүрс үүсгэх
#   7.  POS хэрэглэгч үүсгэх (delguur / delguur123)
#   8.  Desktop shortcut + Авто асаалт
#   9.  Systemd үйлчилгээ
#  10.  Авто нэвтрэлт (LightDM)
#  11.  Системийн оновчлол (CPU, swap, XFCE, дэлгэц)
#  12.  Өдөр тутмын нөөц (cron)
#  13.  Шалгалт
#
...
if [ "$TOTAL_RAM" -lt 2048 ]; then
    warn "RAM ${TOTAL_RAM}MB — 2GB-аас бага. Ажиллахад хүндрэлтэй байж магадгүй."
fi
...
if [ "$OPTIMIZE_XFCE" = "yes" ]; then
    ...
    # XFCE compositor → off (critical for i5 2nd gen GPU)
